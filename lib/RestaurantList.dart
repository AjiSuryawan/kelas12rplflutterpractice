...
import 'package:kelas12rplflutterpractice/RestaurantModel.dart';
import 'dart:convert';
...
class _RestaurantListState extends State<RestaurantList> {
  ...
  void loadFormJson() async{
    ...
    if (res.statusCode == 200) {
      ...
      restaurantModel = RestaurantModel.fromJson(json.decode(res.body.toString()));
      setState(() {
        isloading  = false;
      });
    }else{
                      ...
                      children: <Widget>[
                        Expanded(
                          ...
                          child: ClipRRect(
                            ...
                            child: CachedNetworkImage(
                              height: 100,
                              imageUrl: "https://restaurant-api.dicoding.dev/images/small/"+restaurantModel.restaurants[index].pictureId,
                        ...
                        Expanded(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              Text(restaurantModel.restaurants[index].name,
                                  style: TextStyle(
